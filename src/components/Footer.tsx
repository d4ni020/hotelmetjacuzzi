      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-pure-white mb-8 flex items-center">
        ...
        <div className="mt-16 pt-12 border-t border-brand-navy-700">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-xl font-bold text-pure-white mb-6">
              Mis geen enkele wellness deal!
            </h3>
            <p className="text-brand-navy-200 mb-8 text-lg">
