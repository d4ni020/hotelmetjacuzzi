...
export default function StedenPage() {
  const cities = [
    ...
    { name: 'Den Haag', slug: 'den-haag', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Koninklijke hoofdstad met elegante hotels' },
    { name: 'Leiden', slug: 'leiden', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Historische universiteitsstad met charmante accommodaties' },
    { name: 'Sassenheim', slug: 'sassenheim', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Rustige plaats nabij Leiden met moderne wellness hotels' },
    { name: 'Wassenaar', slug: 'wassenaar', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Elegante badplaats met luxe hotels en spa faciliteiten' },
    { name: 'Nootdorp', slug: 'nootdorp', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Moderne gemeente tussen Den Haag en Delft' },
    { name: 'Ridderkerk', slug: 'ridderkerk', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Centraal gelegen met comfortabele Van der Valk accommodaties' },
    { name: 'Dordrecht', slug: 'dordrecht', province: 'Zuid-Holland', provinceSlug: 'zuid-holland', description: 'Oudste stad van Holland met historische charme en wellness hotels' },
    ...
    { name: 'Huizen', slug: 'huizen', province: 'Noord-Holland', provinceSlug: 'noord-holland', description: 'Prachtige plaats aan het Gooimeer met maritieme hotels' },
    { name: 'De Koog', slug: 'de-koog', province: 'Noord-Holland', provinceSlug: 'noord-holland', description: 'Charmant Texels dorp met strandhotels en wellness faciliteiten' },
    { name: 'Schoorl', slug: 'schoorl', province: 'Noord-Holland', provinceSlug: 'noord-holland', description: 'Natuurlijke rust en wellness hotels nabij de Schoorlse Duinen' },
